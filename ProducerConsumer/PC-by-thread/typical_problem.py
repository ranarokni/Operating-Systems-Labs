...
buffer = [random.randint(1, 150) for i in range(5)] 
...
def producer():
    while len(buffer) <= buffer_size:    # interesting point: change the condition to > and
                                        # the program wil terminate imidiately
